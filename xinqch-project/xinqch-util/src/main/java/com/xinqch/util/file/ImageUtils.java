...
public class ImageUtils {
    ...
    public static void setImageMarkOptions(float alpha , int positionWidth , int positionHeight ,Font font,Color color){
        if(alpha!=0.0f)ImageUtils.alpha = alpha;
        if(positionWidth!=0)ImageUtils.positionWidth = positionWidth;
        if(positionHeight!=0)ImageUtils.positionHeight = positionHeight;
        if(font!=null)ImageUtils.font = font;
        if(color!=null)ImageUtils.color = color;
    }
