...
public class WeatherUtils {
    ...
    public WeatherUtils(String Cityid) throws IOException ,NullPointerException{ 
        // 解析本机ip地址 
...
//        try { 
//            new WeatherUtils("101010100"); // 101010100(北京)就是你的城市代码
//        } catch (Exception e) { 
//            e.printStackTrace(); 
//        } 
//    	String url="http://www.nmc.gov.cn//search_result.php?keys=北京市";
    } 
}
